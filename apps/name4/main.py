...
def main():
    with MoApp(appid='wx01434b3ed0010d28', name='姓名契合度', backgroundColor="#383838"):
        entrance()
        match()
        share()
        #share2()
...
def makeResultUI(name_header, x, y):
        with Box(pos=[0, 60]):
            ...
            Text(name='%sw0' %name_header, text='郑', pos=[43, 268],size=[63,63],textAlign='center',lineHeight=63,color='#F56E6E', fontSize=36,effect=bounceindown(size=(0,1),d=1,t=0.6,c=1,p=1,s=0))
            Text(name='%sw1' %name_header, text='李', pos=[152, 268],size=[63,63],textAlign='center',lineHeight=63,color='#3E4DD2', fontSize=36,effect=bounceindown(size=(0,1),d=1,t=0.6,c=1,p=1,s=0))
            Text(name='%sw2' %name_header, text='红', pos=[259, 268],size=[63,63],textAlign='center',lineHeight=63,color='#F56E6E', fontSize=36,effect=bounceindown(size=(0,1),d=1,t=0.6,c=1,p=1,s=0))
            Text(name='%sw3' %name_header, text='炯', pos=[364, 268],size=[63,63],textAlign='center',lineHeight=63,color='#3E4DD2', fontSize=36,effect=bounceindown(size=(0,1),d=1,t=0.6,c=1,p=1,s=0))
            Text(name='%sw4' %name_header, text='燕', pos=[472, 268],size=[63,63],textAlign='center',lineHeight=63,color='#F56E6E', fontSize=36,effect=bounceindown(size=(0,1),d=1,t=0.6,c=1,p=1,s=0))
            Text(name='%sw5' %name_header, text='❤',pos=[579, 268],size=[63,63],textAlign='center',lineHeight=63,color='#3E4DD2', fontSize=36,effect=bounceindown(size=(0,1),d=1,t=0.6,c=1,p=1,s=0))
            ...
            Image(src='img/jisuan2.jpg', pos=[72, 382], size=[544, 54],effect=fadein(size=(0,1),d=1.5,t=1,c=1,p=1,s=0))
            ...
            Image(src='img/jisuan3.jpg', pos=[128, 467], size=[422, 57],effect=fadein(size=(0,1),d=2.5,t=1,c=1,p=1,s=0))
            ...
            Image(src='img/jisuan4.jpg', pos=[182, 554], size=[324, 56],effect=fadein(size=(0,1),d=3,t=1,c=1,p=1,s=0))
            ...
            Image(src='img/jisuan5.jpg', pos=[237, 643], size=[215, 54],effect=fadein(size=(0,1),d=3.5,t=1,c=1,p=1,s=0))
            ...
            Image(src='img/jisuan6.jpg', pos=[292, 724], size=[108, 61],effect=fadein(size=(0,1),d=4,t=1,c=1,p=1,s=0))
...
class entrance(Page):
    ...
    def commitName():
        ...
        if mo.token.isHost():  #如果是主态
            ...
            mo.token.set('host_name', name) #设置令牌token信息
            ...
            mo.console(host['gender'])
            mo.console(user.name)
...
class match(Page):
    ...
    def UI():
        ...
        with Box(name='match_box', pos=[0, 0], width=750, hidden=True, background='#383838'):
            Image(name='page2image1',pos=[0,0],size=[750,339],src="img/bg3.jpg")
            Text(name='tip1',text='暂时还没有好友来跟你匹配喔',color='white',fontSize=40,pos=['center',420])
            Text(name='tip2',text='点击底部按钮邀请好友来测',color='white',fontSize=40,pos=['center',520])
            ...
            with Mask(name='match_detail_mask', hidden=True):
                with Box(pos=[33, 200], size=[686, 940],border='1px solid #FFFFFF',borderRadius='0%',background='http://img.mogodeer.cn/images/diudiu/ceshi1/wnagge.jpg',boxShadow ='3px 3px 1px 3px rgba(208,63,63,0.9)',marginBottom=50):
