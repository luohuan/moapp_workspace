...
Page({
    ...
    onShareAppMessage: function(opt) {
                    ...
                    let shareInfo = {
                        ...
                        success: function(res) {
                            ...
                            var evt_data = moapp.genEventData("wx08fe2b1ff0c169f2", "page9", self, {});
    ...
    onGetUserInfo_kPAsim:  function(evt) {
                    var self = this;

                    if (evt.detail.userInfo) {
                        app.globalData.userInfo = evt.detail.userInfo;

                        var evt_data = moapp.genEventData("wx08fe2b1ff0c169f2", "page9", self, evt.currentTarget.dataset);
