...
App({
    onLaunch: function(options) {
            ...
            console.log(`launch moapp, appid:wxaa8fe119f5c62d23, env:${this.globalData.env}, signature:${this.globalData.signature}`);
            var self = this;
            /*wx.getSystemInfo({
    ...
    globalData: {
            ...
            env: 'test',
            signature: 'B43A542D508EBE3B9A4D7BEE9CFE262C9E955F47',
