...
App({
    globalData: {
            ...
            env: 'test',
            signature: 'C444D1A04D01482B6B5C89307FF53ABA1BF40ABB',
    ...
    onLaunch: function(options) {
            ...
            console.log(`launch moapp, appid:wx2374ed010f4bd862, env:${this.globalData.env}, signature:${this.globalData.signature}`);
            var self = this;
            /*wx.getSystemInfo({
