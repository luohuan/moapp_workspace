...
Page({
    onButtonTap_6cyEOT:  function(evt) {
                var self = this;
                ;
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx08fe2b1ff0c169f2', 'main', 'share.saveShareImage', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
    ...
    onReady:  function () {
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx08fe2b1ff0c169f2', 'main', 'share.onInit', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
