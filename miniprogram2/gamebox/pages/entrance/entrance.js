...
Page({
    ...
    onGetUserInfo_gKD3Ip:  function(evt) {
                    var self = this;

                    if (evt.detail.userInfo) {
                        app.globalData.userInfo = evt.detail.userInfo;

                        var evt_data = moapp.genEventData("wx08fe2b1ff0c169f2", "entrance", self, evt.currentTarget.dataset);
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx08fe2b1ff0c169f2', 'main', 'entrance.commitName', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
                ...
                ,
    onInputChange_afOnRd:  function(evt) {
                var self = this;
            ...
            ;
                var evt_data = moapp.genEventData("wx08fe2b1ff0c169f2", "entrance", self, evt.detail.value);
            ...
            ,
    onGetUserInfo_5DaVse:  function(evt) {
                    var self = this;
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx08fe2b1ff0c169f2', 'main', 'entrance.computeNameScore', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
    ...
    onShow:  function (opt) {
                    var self = this;
                    var evt_data = moapp.genEventData("wx08fe2b1ff0c169f2", "entrance", self, {});
    ...
    onReady:  function () {
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx08fe2b1ff0c169f2', 'main', 'entrance.onInit', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
    ...
    "__text3_text": "\u7b97\u51fa\u4f60\u4eec\u7684\u7f18\u5206",
    "__text1_top": "400rpx",
    "__auditing_box_top": "0rpx",
    "__text2_fontSize": "24rpx",
    "__button1_disabled": "",
    "__text1_text": "\u7b97\u7b97\u597d\u53cb\u8ddf\u4f60\u7684\u540d\u5b57\u80fd\u5f97\u591a\u5c11\u5206",
    ...
    onPullDownRefresh:  function () {
                    ...
                    var evt_data = moapp.genEventData("wx08fe2b1ff0c169f2", "entrance", self, {});
                    Promise.resolve(evt_data).then( function(evt) {
                return moapp.requestCloudFunction(self, 'wx08fe2b1ff0c169f2', 'main', 'entrance.onPullDownRefresh', evt);
            }
            ).then( res => {
