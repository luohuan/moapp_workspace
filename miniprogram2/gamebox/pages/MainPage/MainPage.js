...
Page({
    onViewTap_jWkoCM:  function(evt) {
                var self = this;
                ;
                var evt_data = moapp.genEventData("wx267c13c76965a037", "MainPage", self, evt.currentTarget.dataset, evt.currentTarget);
...
path: evt.data.path,
            ...
            ;
            return moapp.requestCloudFunction(self, 'wx267c13c76965a037', 'main', 'MainPage.go_to', evt);
        }
    ...
    onShow:  function (opt) {
                    var self = this;
                    var evt_data = moapp.genEventData("wx267c13c76965a037", "MainPage", self, {});
    ...
    onReady:  function () {
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx267c13c76965a037', 'main', 'MainPage.onInit', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
    ...
    onImageTap_iiJfPU:  function(evt) {
                var self = this;
                var evt_data = moapp.genEventData("wx267c13c76965a037", "MainPage", self, evt.currentTarget.dataset);
            ...
            ;
            return moapp.requestCloudFunction(self, 'wx267c13c76965a037', 'main', 'MainPage.ad_goto', evt);
        }
        ).catch( err => {/*console.log("Event exception, err:");console.log(JSON.stringify(err));*/})
            }
            ,
    onImageTap_kEqygo:  function(evt) {
                var self = this;
                var evt_data = moapp.genEventData("wx267c13c76965a037", "MainPage", self, evt.currentTarget.dataset);
