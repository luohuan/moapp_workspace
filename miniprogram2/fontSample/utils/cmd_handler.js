...
module.exports = {    
    ...
    getImageInfo(url){
     ...
     __getClipboardData(ctx, cmd_data, page_data){
      console.log('getClipboadData')
      wx.getClipboardData({
        success:function(res){
          console.log(res)
          ctx.params.params = {}
          ctx.params.params.data = res.data
          ctx.moapp.requestCloudFunction(ctx.page_obj, ctx.appid, ctx.module_name, cmd_data.success.function, ctx.params);
        }
      })
    },
    __setClipboardData(ctx, cmd_data, page_data){
      console.log('setClipboadData')
      wx.setClipboardData({
        data: cmd_data.data,
        success:function(res){
          console.log(res)
    ...
    __setTabBarBadge(ctx, cmd_data, page_data){
      console.log('setTabBarBadge')
      wx.setTabBarBadge({
        index: cmd_data.index,
        text: cmd_data.text
      })
    },
    __removeTabBarBadge(ctx, cmd_data, page_data){
      console.log('removeTabBarBadge')
      wx.removeTabBarBadge({
        index: cmd_data.index
      })
    },
    __showTabBarRedDot(ctx, cmd_data, page_data){
      console.log('showTabBarRedDot')
      wx.showTabBarRedDot({
        index: cmd_data.index
      })
    },
    __hideTabBarRedDot(ctx, cmd_data, page_data){
