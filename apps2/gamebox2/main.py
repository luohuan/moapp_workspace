...
dormitorydata=[
    ...
    {
        'id':10,
        'cover':'http://material.motimaster.com/shiyimin1534921609000/name.jpg',
        'title':'名字契合度',
        'people':'189.34万人在测',
        'details':'你们的名字有多匹配？',
    ...
    {
        'id':2,        
        'cover':'http://material.motimaster.com/shiyimin1534928302000/207596406497299482.png',
        'title':'流星之语',
        'people':'21.09万人在测',
        'details':'来这里，说出你平时不敢说的话吧！',
        'path':'pages/index/index',
...
griditems1 = [
    ...
    # },   
     {
        'id':3,
        'src':'  http://material.motimaster.com/shiyimin1534736683000/yinxiang.png',
        'title':'看你怎么说',
        'people':'129.35万人在测',
