    ...
    with MoApp(name='testdanmu',appid='wx263b9c72fc87b39c'):
        with Page(name='index', background='http://material.motimaster.com/harvey1536219255000/bgk2.jpg'):
            ...
            Button(text='留言管理',size=[120, 60], position='fixed', right=45, top=190,background='rgb(253, 225, 167)', borderRadius=30, boxShadow='0 0 40rpx 2rpx rgb(253, 225, 167)',  
                fontSize=27, lineHeight=60,textAlign='center', color='#444')
            with Input(name='inputDanmu',color='white',placeholder='请输入弹幕',fontSize=27,lineHeight=60,borderBottom='1rpx solid white',left=50,bottom=320,size=[400,60]):
                this.placeholderStyle.color='white'
            Button(size=[140,55], text='发送',onTap = sendBarrage,fontSize=26, background='#08A070',borderRadius=15,type='primary',left=550,bottom=320,lineHeight=55,openType='getUserInfo')
...
async def indexReady(user, app, page, mo):
    ...
    page.danmu.avatarStyle = 'width:35rpx;height:35rpx;left:0;'
