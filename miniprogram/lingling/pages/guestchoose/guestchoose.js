...
Page({
    ...
    onReady:  function () {
                    var self = this;
                    var evt_data = moapp.genEventData("wx87dcda9739af9cb1", "guestchoose", self, {});

                    Promise.resolve(evt_data).then( function(evt) {
                return moapp.requestCloudFunction(self, 'wx87dcda9739af9cb1', 'main', 'guestanswerQuestionReady', evt);
            }
    ...
    onShow:  function (opt) {
            ...
            ,
    onRadioGroupChange_NyTuAE:  function(evt) {
                var self = this;
            ...
            ;
                ...
                var evt_data = moapp.genEventData("wx87dcda9739af9cb1", "guestchoose", self, evt.detail.value);
                Promise.resolve(evt_data).then( function(evt) {
                return moapp.requestCloudFunction(self, 'wx87dcda9739af9cb1', 'main', 'guestafterAnswer', evt);
            }
            ).catch( err => {/*console.log("Event exception, err:");console.log(JSON.stringify(err));*/})
            }
            ,
