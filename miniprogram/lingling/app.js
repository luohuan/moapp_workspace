...
App({
    globalData: {
            ...
            env: 'test',
            signature: 'E98690FCFFD69142B58B8A414957D8EDCB8F2660'
        },
    onLaunch: function(options) {
            this.globalData.scene = options.scene || 0;
            moapp.appBgmAllInOne(this);
            console.log(`launch moapp, appid:wx87dcda9739af9cb1, env:${this.globalData.env}, signature:${this.globalData.signature}`);
            var self = this;
            wx.getSystemInfo({
