...
Page({
    onImageTap_r0o7ut:  function(evt) {
                var self = this;
                var evt_data = moapp.genEventData("wx021a5f382c69640e", "first", self, evt.currentTarget.dataset);
    ...
    onShareAppMessage: function(opt) {
                    ...
                    let shareInfo = {
                        ...
                        success: function(res) {
                            ...
                            var evt_data = moapp.genEventData("wx021a5f382c69640e", "first", self, {});
    ...
    onReady:  function () {
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx021a5f382c69640e', 'main', 'firstReady', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
    ...
    "__bg1_height": "100%",
    "__bg1_src": "http://img.mogodeer.cn/image/xixi/yuelaoqianxian/bg1.jpg",
    "__adbox_top": "950rpx",
    "__adbox_hidden": true,
    "__bg1_width": "100%",
    "objects": [
    ...
    onGetUserInfo_1JfDQV:  function(evt) {
                    var self = this;
