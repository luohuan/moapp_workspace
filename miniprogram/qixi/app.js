...
App({
    onLaunch: function(options) {
            ...
            console.log(`launch moapp, appid:wx47b494af03bd0aae, env:${this.globalData.env}, signature:${this.globalData.signature}`);
            var self = this;
            /*wx.getSystemInfo({
    ...
    globalData: {
            ...
            env: 'test',
            signature: '6FE8A0D87BCBB3B2F309E9D4501C2807CACCD6F0',
