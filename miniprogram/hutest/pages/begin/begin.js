...
Page({
    onShow:  function (opt) {
                    var self = this;
                    var evt_data = moapp.genEventData("wx263b9c72fc87b39c", "begin", self, {});
            ...
            ,
    onGetUserInfo_QMScSn:  function(evt) {
                    var self = this;

                    if (evt.detail.userInfo) {
                        app.globalData.userInfo = evt.detail.userInfo;

                        var evt_data = moapp.genEventData("wx263b9c72fc87b39c", "begin", self, evt.currentTarget.dataset);
                        Promise.resolve(evt_data).then( function(evt) {
