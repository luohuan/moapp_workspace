...
Page({
    ...
    onShow:  function (opt) {
                    var self = this;
                    var evt_data = moapp.genEventData("wx263b9c72fc87b39c", "choose", self, {});
            ...
            ,
    onRadioGroupChange_Y6adBm:  function(evt) {
                var self = this;
            ...
            ;
                ...
                var evt_data = moapp.genEventData("wx263b9c72fc87b39c", "choose", self, evt.detail.value);
                Promise.resolve(evt_data).then( function(evt) {
                return moapp.requestCloudFunction(self, 'wx263b9c72fc87b39c', 'moqiceshi07133', 'afterAnswer', evt);
            }
            ).catch( err => {/*console.log("Event exception, err:");console.log(JSON.stringify(err));*/})
            }
            ,
    ...
    onReady:  function () {
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx263b9c72fc87b39c', 'moqiceshi07133', 'answerQuestionReady', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
