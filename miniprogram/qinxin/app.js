...
App({
    globalData: {
            ...
            env: 'test',
            signature: 'CBD03B43E6E3017E70F31C9CE076B278562B4BEF',
            domain: 'https://api.moapp.mogoboom.com'
        },
    onLaunch: function(options) {
            this.globalData.scene = options.scene || 0;
            moapp.appBgmAllInOne(this);
            console.log(`launch moapp, appid:wx777413533a93b0cf, env:${this.globalData.env}, signature:${this.globalData.signature}`);
            var self = this;
            /*wx.getSystemInfo({
