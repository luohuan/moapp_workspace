...
App({
    onLaunch: function(options) {
            ...
            console.log(`launch moapp, appid:wx01434b3ed0010d28, env:${this.globalData.env}, signature:${this.globalData.signature}`);
            var self = this;
            /*wx.getSystemInfo({
    ...
    globalData: {
            ...
            env: 'dev',
            signature: 'EC662B150F2918C21E3A3FCF2EDF9265D7611E99',
