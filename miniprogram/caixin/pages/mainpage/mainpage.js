...
Page({
    onShareAppMessage: function(opt) {
                    ...
                    let shareInfo = {
                        ...
                        success: function(res) {
                            ...
                            var evt_data = moapp.genEventData("wx18610e0755615e2f", "mainpage", self, {});
    ...
    onReady:  function () {
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx18610e0755615e2f', 'main', 'mainpageReady', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
    ...
    onGetUserInfo_xHywRq:  function(evt) {
                    var self = this;

                    if (evt.detail.userInfo) {
                        app.globalData.userInfo = evt.detail.userInfo;

                        var evt_data = moapp.genEventData("wx18610e0755615e2f", "mainpage", self, evt.currentTarget.dataset);
                        Promise.resolve(evt_data).then( function(evt) {
            var params = 
            {
                page: "questpage",
