...
App({
    globalData: {
            ...
            env: 'test',
            signature: '1FBF458577245756B8F7CAC2FE9304288E67B67C',
            domain: 'https://api.moapp.mogoboom.com'
        },
    onLaunch: function(options) {
            this.globalData.scene = options.scene || 0;
            moapp.appBgmAllInOne(this);
            console.log(`launch moapp, appid:wx18610e0755615e2f, env:${this.globalData.env}, signature:${this.globalData.signature}`);
            var self = this;
            /*wx.getSystemInfo({
