...
Page({
    ...
    onShow:  function (opt) {
            ...
            ,
    onGetUserInfo_zUahIV:  function(evt) {
                    var self = this;
    ...
    onReady:  function () {
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx263b9c72fc87b39c', 'main', 'indexReady', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
    ...
    "__avatar_top": "350rpx",
    "__avatar_height": "190rpx",
    "__num_fontSize": "40rpx",
    "__num_text": "2018023301",
    "__avatar_right": "0rpx",
    "__num_left": "330rpx",
    "__num_color": "black",
    "__num_width": "386rpx",
    "__num_top": "712rpx",
    "__avatar_width": "190rpx",
    "__num_height": "48rpx",
    "__avatar_left": "0rpx"
},
