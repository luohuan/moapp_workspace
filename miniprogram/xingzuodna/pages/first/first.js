...
Page({
    ...
    onShareAppMessage: function(opt) {
                    ...
                    let shareInfo = {
                        ...
                        success: function(res) {
                            ...
                            var evt_data = moapp.genEventData("wx263b9c72fc87b39c", "first", self, {});
    ...
    onGetUserInfo_ILZZKu:  function(evt) {
                    var self = this;

                    if (evt.detail.userInfo) {
                        app.globalData.userInfo = evt.detail.userInfo;

                        var evt_data = moapp.genEventData("wx263b9c72fc87b39c", "first", self, evt.currentTarget.dataset);
