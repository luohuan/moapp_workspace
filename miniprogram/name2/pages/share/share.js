...
Page({
    ...
    onButtonTap_u3f30b:  function(evt) {
                var self = this;
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx263b9c72fc87b39c', 'main', 'share.saveShareImage', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
    ...
    onReady:  function () {
            ...
            return evt;
                ...
                return moapp.requestCloudFunction(self, 'wx263b9c72fc87b39c', 'main', 'share.onInit', evt);
            }
            ).then( function(evt) {
            wx.hideLoading();
            return evt
